...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcReactSocrataNumberfilter = __webpack_require__(157);

	var _srcReactSocrataNumberfilter2 = _interopRequireDefault(_srcReactSocrataNumberfilter);

	_react2['default'].render(_react2['default'].createElement(_srcReactSocrataNumberfilter2['default'], { name: 'Licence Costs' }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactSocrataNumberranges = __webpack_require__(158);

	var _reactSocrataNumberranges2 = _interopRequireDefault(_reactSocrataNumberranges);

	var _numberfilterScss = __webpack_require__(159);

	var _numberfilterScss2 = _interopRequireDefault(_numberfilterScss);

	var SocrataNumberfilter = (function (_React$Component) {
	  _inherits(SocrataNumberfilter, _React$Component);

	  function SocrataNumberfilter(props) {
	    _classCallCheck(this, SocrataNumberfilter);

	    _get(Object.getPrototypeOf(SocrataNumberfilter.prototype), 'constructor', this).call(this, props);
	  ...
	  _createClass(SocrataNumberfilter, [{
	    key: 'toggleRangeContainer',
	    value: function toggleRangeContainer() {
	      this.state.editing ? this.setState({ 'editing': false }) : this.setState({ 'editing': true });
	    }
	  }, {
	    key: 'deleteBound',
	    value: function deleteBound(deleteSide) {
	      if (deleteSide == 'lower') {
	        this.setState({
	          'lowerBound': null,
	          'editableLower': false
	    ...
	    key: 'handleBoundSet',
	    value: function handleBoundSet(num, whichBound) {
	      if (whichBound == 'upper') {
	    ...
	    key: 'handleEditableToggle',
	    value: function handleEditableToggle(whichBound, bool) {
	      if (whichBound == 'upper') {
	    ...
	    value: function handleChangeInput(whichBound, val) {
	      var obj = {};
	    ...
	    value: function renderEdit() {
	      if (this.state.editing) {
	        return _react2['default'].createElement(_reactSocrataNumberranges2['default'], {
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'div',
	            { className: 'inputPresenter' },
	            this.renderRanges(),
	            _react2['default'].createElement('i', { className: 'btn-toggle fa fa-chevron-down',
	              onClick: this.toggleRangeContainer.bind(this) })
	          ),
	          this.renderEdit()
	        )
	      );
	  ...
	  _createClass(NumberRanges, [{
	    ...
	    value: function componentDidUpdate() {
	      if (this.state.editingRefName) {
	        _react2['default'].findDOMNode(this.refs[this.state.editingRefName]).focus();
	      }
	    }
	  }, {
	    key: 'toggleBoundAvailability',
	    value: function toggleBoundAvailability(whichBound, e) {
	      if (e.target.checked) {
	    ...
	    key: 'handleChangeInput',
	    value: function handleChangeInput(whichBound, e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/autoprefixer-loader/index.js!./../node_modules/sass-loader/index.js!./numberfilter.scss", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/autoprefixer-loader/index.js!./../node_modules/sass-loader/index.js!./numberfilter.scss");
