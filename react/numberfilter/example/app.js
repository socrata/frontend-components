...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactSocrataNumberranges = __webpack_require__(159);
	...
	var SocrataNumberfilter = (function (_React$Component) {
	  ...
	  function SocrataNumberfilter(props) {
	    ...
	    var self = this;
	    (0, _jquery2['default'])('html').click(function (e) {
	      if ((0, _jquery2['default'])(e.target).parents('.rangeFilter').length == 0) {
